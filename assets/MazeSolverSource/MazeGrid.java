...
public class MazeGrid extends JFrame {
    ...
    public MazeGrid(MazeSolver solver, int dimension) {
        pathColor = new Color(255,20,147);
        DIMENSION = dimension;
        this.solver = solver;
        setWindowAttributes();
        setLookAndFeel();
...
////////////////////////////////////////////////////////////////////////
    ...
    private void initPuzzle() {
        ...
        for(int i = 1; i < DIMENSION; i+=2 )
            for(int j=0; j < DIMENSION; j++)  {
                ...
                if(x > 1)
                    gridLabels[j][i].setBackground(Color.BLUE);
            }   
        ...
        gridLabels[0][0].setBackground(Color.BLACK);
        gridLabels[0][1].setBackground(Color.YELLOW);
        gridLabels[1][1].setBackground(Color.YELLOW);
        gridLabels[1][0].setBackground(Color.YELLOW);
        gridLabels[DIMENSION-1][DIMENSION-1].setBackground(Color.green);
        gridLabels[DIMENSION-1][DIMENSION-2].setBackground(Color.YELLOW);
        gridLabels[DIMENSION-2][DIMENSION-2].setBackground(Color.YELLOW);
        gridLabels[DIMENSION-2][DIMENSION-1].setBackground(Color.YELLOW);
        repaint();
        }
    ...
    // within the grid, and the background is not Blue.
    ...
    // may be valid if the cell is within the grid, and does not have a Blue background.
    ...
    public boolean isValidMove(GridCell cell) {
        ...
        if(gridLabels[x][y].getBackground().equals(Color.BLUE))
            return false;            
        return true;
        }
